...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference("Gym.count") do
      post gyms_url, params: { gym: { address: @gym.address, email: @gym.email, hours: @gym.hours, name: @gym.name, phone: @gym.phone, status: @gym.status } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { address: @gym.address, email: @gym.email, hours: @gym.hours, name: @gym.name, phone: @gym.phone, status: @gym.status } }
